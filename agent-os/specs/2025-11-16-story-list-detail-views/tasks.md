...
- [x] 1. **Document Story-only feed contract**
...
- [x] 2. **Ensure timeline query supports Story filter**
...
- [x] 3. **Surface Story detail payload fields**
...
- [x] 4. **Propagate list updates after edit/delete**
...
- [x] 5. **Create Story filter mode in unified timeline provider**
...
- [x] 6. **Implement Story-only card variant**
...
- [x] 7. **Hook filter mode into screen scaffolding**
...
- [x] 8. **Refactor detail layout order**
...
- [x] 9. **Implement sticky audio player module**
...
- [x] 10. **Align metadata + action pills with Moment spec**
